...
Avatar::Avatar(PowerManager *_powers, InputState *_inp, MapIso *_map, MessageEngine *_msg) : Entity(_map), powers(_powers), inp(_inp) {
	...
	loadAnimations(PATH_MOD + "animations/hero.txt");
}
...
void Avatar::loadGraphics(string _img_main, string _img_armor, string _img_off) {
	...
	if (_img_main != img_main || _img_armor != img_armor || _img_off != img_off) {
		...
		sprites = IMG_Load((PATH_MOD + "images/avatar/" + stats.base + "/" + img_armor + ".png").c_str());
		if (img_main != "") gfx_main = IMG_Load((PATH_MOD + "images/avatar/" + stats.base + "/" + img_main + ".png").c_str());
		if (img_off != "") gfx_off = IMG_Load((PATH_MOD + "images/avatar/" + stats.base + "/" + img_off + ".png").c_str());
		gfx_head = IMG_Load((PATH_MOD + "images/avatar/" + stats.base + "/" + stats.head + ".png").c_str());
...
void Avatar::loadSounds() {
	sound_melee = Mix_LoadWAV((PATH_MOD + "soundfx/melee_attack.ogg").c_str());
	sound_hit = Mix_LoadWAV((PATH_MOD + "soundfx/" + stats.base + "_hit.ogg").c_str());
	sound_die = Mix_LoadWAV((PATH_MOD + "soundfx/" + stats.base + "_die.ogg").c_str());
	sound_block = Mix_LoadWAV((PATH_MOD + "soundfx/powers/block.ogg").c_str());	
	sound_steps[0] = Mix_LoadWAV((PATH_MOD + "soundfx/step_echo1.ogg").c_str());
	sound_steps[1] = Mix_LoadWAV((PATH_MOD + "soundfx/step_echo2.ogg").c_str());
	sound_steps[2] = Mix_LoadWAV((PATH_MOD + "soundfx/step_echo3.ogg").c_str());
	sound_steps[3] = Mix_LoadWAV((PATH_MOD + "soundfx/step_echo4.ogg").c_str());
	level_up = Mix_LoadWAV((PATH_MOD + "soundfx/level_up.ogg").c_str());
