...
void MenuCharacter::loadGraphics() {
	...
	background = IMG_Load((PATH_MOD + "images/menus/character.png").c_str());
	proficiency = IMG_Load((PATH_MOD + "images/menus/character_proficiency.png").c_str());
	upgrade = IMG_Load((PATH_MOD + "images/menus/upgrade.png").c_str());
