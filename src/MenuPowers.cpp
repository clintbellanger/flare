...
void MenuPowers::loadGraphics() {
	...
	background = IMG_Load((PATH_MOD + "images/menus/powers.png").c_str());
	powers_step = IMG_Load((PATH_MOD + "images/menus/powers_step.png").c_str());
	powers_unlock = IMG_Load((PATH_MOD + "images/menus/powers_unlock.png").c_str()); 
