...
public:
	...
	Point calc_size(std::string const& text_with_newlines, int width);

	void render(std::string const& text, int x, int y, int justify, SDL_Surface *target, int color);
	void render(std::string const& text, int x, int y, int justify, SDL_Surface *target, int width, int color);
	void renderShadowed(std::string const& text, int x, int y, int justify, SDL_Surface *target, int color);
	void renderShadowed(std::string const& text, int x, int y, int justify, SDL_Surface *target, int width, int color);
