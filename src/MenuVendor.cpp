 ...
 */
ItemStack MenuVendor::click(const InputState &input) {
...
void MenuVendor::checkTooltip(WidgetTooltip &tip, const Point &mouse) {
	stock.checkTooltip(tip, mouse, stats, true);
}
